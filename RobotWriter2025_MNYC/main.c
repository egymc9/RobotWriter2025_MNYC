...
#include "main_fn.h" // Include main function header file
...
int main()
{
    ...
    // Terminate if COM port cannot be opened
    ...
    if (data && buffer_seq) 
    {
        ...
        // Dynamic memory allocation for the stroke data array
        ...
        // This is a special case - wait for dollar ($)
        WaitForDollar();
        ...
        // This loop generates the G-Code pattern read from the stroke data per row
        for (int i = 0; i < strokes; i++) 
        {
            int drawG; // Integer variable to distinguish when to pen down
        ...
        // G-Code reset position after finished drawing
